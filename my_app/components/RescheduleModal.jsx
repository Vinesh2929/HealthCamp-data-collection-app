...
const RescheduleModal = ({ visible, onClose, onSubmit, patientName, appointment }) => {
  ...
  // Set initial values when the modal becomes visible and appointment data is available
  useEffect(() => {
